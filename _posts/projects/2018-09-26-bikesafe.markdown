...
* **choosing the most promising path** - route calculation was still computed by Google Maps (mainly because I wanted the sponsor stickers, but I guess their tech is pretty cool too).
...
* **robust <a href="https://developers.google.com/maps/documentation/javascript/examples/polyline-simple">polyline</a> rendering** - it took so long, just to display a lines from point A to point B. AHHHH.
